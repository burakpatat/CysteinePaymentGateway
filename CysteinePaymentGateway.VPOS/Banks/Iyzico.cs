...
using System.Text;
using CysteinePaymentGateway.VPOS.Iyzico;
using CysteinePaymentGateway.VPOS.Iyzico.Request;
using CysteinePaymentGateway.VPOS.Iyzico.Model;

namespace CysteinePaymentGateway.VPOS.Banks.Iyzico
{
    internal class IyzicoVirtualPOSService : ICysteineVirtualPOSService
    {
        ...
        public CancelResponse Cancel(CancelRequest request, VirtualPOSAuth auth)
        {
            ...
            CysteinePaymentGateway.VPOS.Iyzico.Model.Cancel _cancelResponse = CysteinePaymentGateway.VPOS.Iyzico.Model.Cancel.Create(req, GetOptions(auth));
        ...
        public RefundResponse Refund(RefundRequest request, VirtualPOSAuth auth)
        {
            ...
            CysteinePaymentGateway.VPOS.Iyzico.Model.Refund amountBasedRefund = CysteinePaymentGateway.VPOS.Iyzico.Model.Refund.CreateAmountBasedRefundRequest(req, GetOptions(auth));
